CREATE DATABASE Filmes_Fodasticos;
...
SELECT titulo, duracao_min FROM Filme WHERE genero = 'comedia' AND duracao_min <= 95;
SELECT * FROM Filme WHERE genero = 'Animacao' OR genero = 'Aventura';
...
SELECT titulo, duracao_min FROM Filme WHERE genero = 'Romance' ORDER BY duracao_min DESC;
SELECT * FROM Filme WHERE classificacao = '18' ORDER BY duracao_min DESC;
SELECT titulo, genero, duracao_min FROM Filme WHERE duracao_min < 100 ORDER BY titulo ASC;
