...
ALTER TABLE Produtos MODIFY COLUMN nome VARCHAR(222);
DESC Produtos;
...
ALTER TABLE Usuarios RENAME COLUMN id TO id_usuarios;
DESC Tbl_Antiga;
...
INSERT INTO Mensagens VALUES(1,'teste','expurgada');
